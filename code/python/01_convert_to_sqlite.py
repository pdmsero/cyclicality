...
def build_tasks() -> List[Task]:
    ...
    raw_dta_map = [
        ...
        ("raw_gdp", "stata_baseline/GDPData_RawFile.dta", [["year"]], None),
        ("raw_bond_yields", "stata_baseline/BondYields.dta", [["year"]], None),
        ("raw_social_security_wage", "stata_baseline/SocialSecurityWageData.dta", [["year"]], None),
        ("raw_stock_market", "stata_baseline/StockMarketData.dta", [["key", "year"], ["sic"], ["naics"]], None),
        ("raw_nber_ces", "stata_baseline/nberces5818v1_n2012.dta", [["naics"], ["year"]], None),
    ]
    ...
    processed_dta_map = [
        ("processed_alldata", "stata_baseline/AllData.dta", [["gvkey"], ["key", "year"], ["sic"], ["naics"]]),
        ("processed_compustat", "stata_baseline/compustat.dta", [["key", "year"], ["sic"], ["naics"]]),
        ("processed_compustat_nber", "stata_baseline/[2]_final_data_compustat_NBER.dta", [["key", "year"], ["sic"], ["naics"]]),
        ("processed_compustat_bea_3digit", "stata_baseline/[3]_compustat_BEA_3digits.dta", [["key", "year"], ["sic"], ["naics"]]),
        ("processed_compustat_bea_2digit", "stata_baseline/[4]_compustat_BEA_2digits.dta", [["key", "year"], ["sic"], ["naics"]]),
        ("processed_financial_constraints", "stata_baseline/[5]_data_financial_constraints.dta", [["key", "year"], ["sic"], ["naics"]]),
        ...
        ("processed_gdp", "stata_baseline/GDPData.dta", [["year"]]),
        ("processed_rnd_industry", "stata_baseline/[1]_RND_Industry_data_final.dta", None),
        ("processed_bea_va_step3", "stata_baseline/[3]_BEA_ Value_Added.dta", None),
        ("processed_deflator", "stata_baseline/deflator.dta", None),
        ("processed_hib", "stata_baseline/hib.dta", None),
        ("processed_industrysales", "stata_baseline/industrysales.dta", None),
        ("processed_exports", "stata_baseline/Exports.dta", [["sic"], ["year"]]),
        ("processed_all_data_macro", "stata_baseline/all_data.dta", None),
        ("processed_va_vship_gdp_p", "stata_baseline/va.vship.gdp.p.dta", None),
        ("lookup_sic5805", "stata_baseline/sic5805.dta", None),
        ("processed_sic_manufacturing_2digit", "stata_baseline/SIC.manufacturing.2digit.dta", None),
        ("processed_sic_manufacturing_3digit", "stata_baseline/SIC.manufacturing.3digit.dta", None),
        ("processed_sic_manufacturing_4digit", "stata_baseline/SIC.manufacturing.4digit.dta", None),
        ("processed_solow_residual_1939", "stata_baseline/1939-2011_solowresidual.dta", None),
        ("processed_solow_residual_1960", "stata_baseline/1960-2002_estimatesolowresidual.dta", None),
        ("processed_averagewage", "stata_baseline/averagewage.dta", None),
        ("processed_obsdistribution", "stata_baseline/obsdistribution.dta", None),
        ("processed_outputdata", "stata_baseline/outputdata.dta", None),
        ("processed_outputdatawithrnd", "stata_baseline/outputdatawithrnd.dta", None),
        ("processed_volatilitytfe", "stata_baseline/volatilitytfe.dta", None),
        ("lookup_naics_to_sic", "stata_baseline/naics_to_sic.dta", None),
        ("lookup_codes_naics_sic", "stata_baseline/codes_naics_sic.dta", None),
        ("lookup_bea_naics_two_digit", "stata_baseline/bea_naics_two_digit.dta", None),
        ("lookup_bea_naics_three_digit", "stata_baseline/bea_naics_three_digit.dta", None),
        ("lookup_two_digit_bea_naics", "stata_baseline/two_digit_bea_naics.dta", None),
    ]
    ...
    tasks.append(
        Task(
            ...
            DATA_DIR / "stata_baseline" / "Country_RD_GDP_Clean.csv",
            "csv",
